...
<div class="nav">
	...
	<div class="container-heading">
		<h1 class="heading">Manage Student</h1>
	</div>
	<div class="container-list">
		...
		<c:forEach items="${studentlist}" var="studentinfo" varStatus="status" >
			<tr class="${status.count % 2 == 0 ? 'even' : 'odd' }">
				...
				<td><a href="editstudent?sid=${studentinfo.id}" style="color:blue"><i class="fas fa-pen"></i></a></td>
				<td><a href="deletestudent?sid=${studentinfo.id}" style="color:red"><i class="fas fa-trash-alt"></i></a></td> 
			</tr>	
		</c:forEach>
		</table>
	</div>
